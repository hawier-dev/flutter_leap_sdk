  ...
  group('FlutterLeapSdkService', () {
    ...
    setUp(() {
      ...
      TestDefaultBinaryMessengerBinding.instance.defaultBinaryMessenger
          .setMockMethodCallHandler(const MethodChannel('flutter_leap_sdk'), (
    ...
    test('generateResponse works when model is loaded', () async {
      ...
      final result = await FlutterLeapSdkService.generateResponse(
        'test message',
      );
    ...
    test('exceptions have correct messages and codes', () {
      ...
      expect(
        exception.toString(),
        'FlutterLeapSdkException(TEST_CODE): Test error',
      );
    });
  });
}
