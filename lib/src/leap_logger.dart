...
class LeapLogger {
  ...
  static void initialize({LogLevel? minLevel, bool? enableFileLogging}) {
    if (minLevel != null) {
      _minLevel = minLevel;
    }
  }
  ...
  static void _log(
    ...
    final logMessage =
        '${_formatTimestamp(timestamp)} $levelStr [LEAP] $message';
    ...
    if (kDebugMode) {
      ...
      if (error != null) {
        print(
          '${_formatTimestamp(timestamp)} ERROR    [LEAP] Exception: $error',
        );
      }
